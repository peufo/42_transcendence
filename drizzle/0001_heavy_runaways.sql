ALTER TABLE `matches` RENAME COLUMN "scoreToWin" TO "pointsToWin";--> statement-breakpoint
...
CREATE TABLE `__new_friendships` (
	...
	`createdAt` integer DEFAULT '"2025-09-14T18:34:14.081Z"' NOT NULL,
...
CREATE TABLE `__new_tournaments_participants` (
	...
	`joinedAt` integer DEFAULT '"2025-09-14T18:34:14.081Z"' NOT NULL,
...
CREATE TABLE `__new_users` (
	...
	`createdAt` integer DEFAULT '"2025-09-14T18:34:14.080Z"' NOT NULL,
	`lastLogin` integer DEFAULT '"2025-09-14T18:34:14.080Z"' NOT NULL,
