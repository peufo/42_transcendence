...
CREATE TABLE `__new_friendships` (
	...
	`createdAt` integer DEFAULT '"2025-09-14T18:55:19.130Z"' NOT NULL,
...
CREATE TABLE `__new_tournaments_participants` (
	...
	`joinedAt` integer DEFAULT '"2025-09-14T18:55:19.130Z"' NOT NULL,
...
CREATE TABLE `__new_users` (
	...
	`createdAt` integer DEFAULT '"2025-09-14T18:55:19.129Z"' NOT NULL,
	`lastLogin` integer DEFAULT '"2025-09-14T18:55:19.129Z"' NOT NULL,
