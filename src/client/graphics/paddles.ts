...
export function createPaddles(
	scene: BABYLON.Scene,
	p1material: BABYLON.Material,
	p2material: BABYLON.Material,
) {
...
export async function createPaddles(
	...
	try {
		// const _result = await BABYLON.SceneLoader.AppendAsync(
		// 	'/public/textures/paddle/croissant/', // Chemin corrigé
		// 	'croissant_4k.gltf',
		// 	scene,
		// )
