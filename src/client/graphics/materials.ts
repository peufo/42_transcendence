export function createPaddleMaterial(scene: BABYLON.Scene): BABYLON.StandardMaterial {
...
export function createPaddleMaterial2(scene: BABYLON.Scene): BABYLON.PBRMaterial {
